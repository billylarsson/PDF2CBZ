...
class CythonCompiler:
    def __init__(self, source_file_name, subfolder=None, force_update=False, spare_work_files=True):
        """
        :param source_file_name: this is __file__ from launching program
        ...
        if platform.system() == "Windows":
            source_dir = os.path.realpath(source_file_name)[0:os.path.realpath(source_file_name).rfind('\\')]
        else:
            source_dir = os.path.realpath(source_file_name)[0:os.path.realpath(source_file_name).rfind('/')]
